...
switch ($page) {
  ...
  case 'export': $page_title = 'Exportar usu&aacuterios';break;
  ...
  case 'sendprepared': $page_title = 'Enviar uma mensagem pronta';break;
  case 'members': $page_title = 'Lista de Membros';break;
  case 'users': $page_title = 'Lista de Todos os usu&aacuterios';break;
  ...
  case 'defaults': $page_title = 'Alguns atributos padr&atildeo &uacuteteis';break;
  ...
  case 'processbounces': $page_title = 'Buscar emails com problemas a partir do servidor';break;
  case 'bounces': $page_title = 'Listar emails com problemas';break;
  case 'bounce': $page_title = 'Exibir um email com problema';break;
  case 'spageedit': $page_title = 'Editar uma p&aacute;gina de inscri&ccedil;&atilde;o';break;
  case 'spage': $page_title = 'p&acute;ginas de Inscri&ccedil;&atilde;o';break;
